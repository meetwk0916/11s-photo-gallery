...
def build_xiaohongshu_preview(post: PhotoPost, content: Dict) -> Dict:
    ...
    return {
        ...
        "likes": state.config.dummy_xhs_likes,
        "saves": state.config.dummy_xhs_saves,
        "comments": state.config.dummy_xhs_comments,
        "author": {
...
def build_instagram_preview(post: PhotoPost, content: Dict) -> Dict:
    ...
    return {
        ...
        "avatar": state.config.author_avatar,
        "likes": state.config.dummy_ig_likes,
        "caption": ig.get("caption", ""),
        "hashtags": ig.get("hashtags", []),
        "location": ig.get("location_tag", ""),
        "comments_count": state.config.dummy_ig_comments_count,
...
def build_linkedin_preview(post: PhotoPost, content: Dict) -> Dict:
    ...
    return {
        ...
        "cta": li.get("cta", ""),
        "likes": state.config.dummy_li_likes,
        "comments": state.config.dummy_li_comments,
        "reposts": state.config.dummy_li_reposts,
    }
