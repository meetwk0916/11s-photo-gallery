...
def build_xiaohongshu_preview(post: PhotoPost, content: Dict) -> Dict:
    ...
    return {
        ...
        "likes": state.config.dummy_likes,
        "saves": state.config.dummy_saves,
        "comments": state.config.dummy_comments,
        "author": {"name": state.config.author_name, "avatar": state.config.author_avatar, "followers": state.config.author_followers},
...
def build_instagram_preview(post: PhotoPost, content: Dict) -> Dict:
    ...
    return {
        ...
        "comments_count": state.config.dummy_comments,
...
def build_linkedin_preview(post: PhotoPost, content: Dict) -> Dict:
    ...
    return {
        ...
        "likes": state.config.dummy_likes,
        "comments": state.config.dummy_comments,
        "reposts": state.config.dummy_reposts,
    }
