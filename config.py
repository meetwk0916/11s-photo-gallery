...
class PipelineConfig:
    ...
    dummy_xhs_likes: str = "1.2k"
    dummy_xhs_saves: str = "856"
    dummy_xhs_comments: str = "128"
    dummy_ig_likes: str = "2.4k"
    dummy_ig_comments_count: str = "42"
    dummy_li_likes: str = "328"
    dummy_li_comments: str = "18"
    dummy_li_reposts: str = "24"
